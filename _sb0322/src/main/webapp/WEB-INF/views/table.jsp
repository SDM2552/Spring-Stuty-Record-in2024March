...
<body>
    <form id="editForm" method="post" action="insert">
        <table class="table1">
            <tr>
                <td>이름</td>
                <td><input type="text" name="name" id="editName" placeholder="이름"></td>
            </tr>
            <tr>
                <td>나이</td>
                <td><input type="text" name="age" id="editAge" placeholder="나이"></td>
            </tr>
            <tr>
                <td>메일</td>
                <td><input type="text" name="email" id="editEmail" placeholder="메일"></td>
            </tr>
            <tr>
                <td>메모</td>
                <td><input type="text" name="memo" id="editMemo" placeholder="메모"></td>
            </tr>
            <tr>
                <td></td>
                <td> <input type="submit" id="submitButton" value="회원 등록"> <div id="buttonContainer"></div>
            </tr>
        </table>
    </form>
    <hr>
