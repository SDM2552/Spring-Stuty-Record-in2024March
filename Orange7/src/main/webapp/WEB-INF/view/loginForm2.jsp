...
%>
    ...
    <button class="btn btn-primary w-100 py-2" type="button" onclick="window.location.href='signUp';">회원 가입</button>
    <button class="btn btn-primary w-100 py-2 lastbtn" type="button" onclick="window.location.href='move2';">메인으로</button>
